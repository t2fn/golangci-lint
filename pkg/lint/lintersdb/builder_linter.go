...
import (
	...
	"github.com/t2fn/golangci-lint/v2/pkg/golinters"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/arangolint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/asasalint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/asciicheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/bidichk"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/bodyclose"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/canonicalheader"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/clickhouselint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/containedctx"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/contextcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/copyloopvar"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/cyclop"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/decorder"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/depguard"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/dogsled"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/dupl"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/dupword"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/durationcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/embeddedstructfieldcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/err113"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/errcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/errchkjson"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/errname"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/errorlint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/exhaustive"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/exhaustruct"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/exptostd"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/fatcontext"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/forbidigo"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/forcetypeassert"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/funcorder"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/funlen"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gci"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/ginkgolinter"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gocheckcompilerdirectives"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gochecknoglobals"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gochecknoinits"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gochecksumtype"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gocognit"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/goconst"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gocritic"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gocyclo"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/godoclint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/godot"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/godox"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gofmt"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gofumpt"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/goheader"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/goimports"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/golines"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gomoddirectives"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gomodguard"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/goprintffuncname"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gosec"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/gosmopolitan"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/govet"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/grouper"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/iface"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/importas"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/inamedparam"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/ineffassign"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/interfacebloat"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/intrange"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/iotamixing"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/ireturn"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/lll"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/loggercheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/maintidx"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/makezero"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/mirror"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/misspell"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/mnd"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/modernize"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/musttag"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nakedret"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nestif"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nilerr"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nilnesserr"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nilnil"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nlreturn"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/noctx"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/noinlineerr"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nolintlint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nonamedreturns"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/nosprintfhostport"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/paralleltest"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/perfsprint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/prealloc"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/predeclared"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/promlinter"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/protogetter"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/reassign"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/recvcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/revive"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/rowserrcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/sloglint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/spancheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/sqlclosecheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/staticcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/swaggo"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/tagalign"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/tagliatelle"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/testableexamples"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/testifylint"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/testpackage"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/thelper"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/tparallel"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/unconvert"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/unparam"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/unqueryvet"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/unused"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/usestdlibvars"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/usetesting"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/varnamelen"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/wastedassign"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/whitespace"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/wrapcheck"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/wsl"
	"github.com/t2fn/golangci-lint/v2/pkg/golinters/zerologlint"
